...
import * as read_attachment from './read_attachment.js';
import * as note_student_assumption from './note_student_assumption.js';
import * as record_practice_result from './record_practice_result.js';
import * as property_lookup from './property_lookup.js';
import * as plot_property_diagram from './plot_property_diagram.js';
import * as show_on_board from './show_on_board.js';
import * as choose_style from './choose_style.js';
import * as calculate from './calculate.js';
import * as check_constraints from './check_constraints.js';
...
export const IMPLEMENTATIONS = {
  ...
  read_attachment,
  note_student_assumption,
  record_practice_result,
  property_lookup,
  plot_property_diagram,
  show_on_board,
  choose_style,
  calculate,
  check_constraints,

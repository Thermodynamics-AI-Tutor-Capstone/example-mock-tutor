...
export async function buildSystemPrompt({ skills, knowledge, style = null, tutoringState = null, extraSections = [] } = {}) {
...
export async function runAgentTurn({
  ...
  const systemPrompt = await buildSystemPrompt({ skills, knowledge, style, tutoringState, extraSections });
  const ctx = {
    skills,
    knowledge,
    conversationId,
